$(function () {
  ...
  const questions = {
    ...
    q2: { number:"Q2/3",  text: "カードは6枚以上持ち歩く", yes: "q4", no: "q5" },
    q3: { number:"Q2/3", text: "カードは6枚以上持ち歩く", yes: "q6", no: "q7" },
    q4: {
      number:"Q3/3",
      ...
      $("#questionArea").fadeOut(200, function () {
        ...
        switch (q) {
          case "EPOCK":
            ...
            productUrl =
              "https://boab.official.ec/categories/5521204";
            break;
          case "Money clip-1":
            imagePath = "img/moneyclip1.png"
            description = "現金派で，たくさん入ってスリムな財布を求めるわがままなあなたには，Money clipがおすすめ。個性的な札バサミ金具を使うことで，カードを10枚収納できる大容量と，薄さを両立しています。";
            productUrl =
              "https://boab.official.ec/categories/2300305";
          case "Money clip-2":
          ...
          case "inz-1":
            ...
            description ="現金派で，潔いミニマリストなあなたにはinzがおすすめ。ほぼカードサイズの財布ながら，札も小銭もダントツに使いやすいわがままを詰め込んだ財布です。";
            productUrl =
            "https://boab.official.ec/search?q=inz";
            break;
          case "inz-2":
          ...
          case "a.o.p-1":
            ...
            description ="現金派で，カードも4〜5枚入る財布をお探しのあなたにはa.o.pがおすすめ。片手にすっぽりおさまるサイズながら，大きく開く小銭入れと1万円札も曲げずに収納可能な札入れできっと，長く使いたい財布になるはず。";
            productUrl =
            "https://boab.official.ec/categories/5521203";
            break;
          case "a.o.p-2":
          ...
          case "mini wallet":
            ...
            description =
              "カードがたっぷり入ってコンパクトな財布が好みなキャッシュレス派のあなたにはmini walletがおすすめ。カードが多くて目的のカードを見つけやすいmini walletはあなたのライフスタイルにぴったり。キャッシュレスが進んだ今でも現金決済しかできない場面もまだあるもの。でも，mini walletなら現金も予備で持ち。";
              productUrl =
              "https://boab.official.ec/categories/5521255";
            break;
        }
